...
namespace GameJam.Plugins.Procedural
{
	...
	#else
	public class ProceduralTextureOdinDrawer : OdinAttributeProcessor<ProceduralTexture>
	{
		public override void ProcessChildMemberAttributes(InspectorProperty parentProperty, MemberInfo member, List<Attribute> attributes)
		{
			if (member.Name == "_texture")
			{
				attributes.Add(new PreviewFieldAttribute(height: 150));
			}
		}
	}
#endif

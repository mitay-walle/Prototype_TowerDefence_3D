...
namespace TD
{
	public class ButtonSector : Button
	{
		// Selection logic
		...
		public Selectable FindSelectableCustom(Vector3 dir)
		{
			...
			for (int i = 0; i < s_SelectableCount; ++i)
			{
				...
				Vector3 selCenter = selRect != null ? selRect.transform.position : Vector3.zero;
		...
		public override Selectable FindSelectableOnLeft()
		{
			...
			{
				return FindSelectableCustom(transform.rotation * Vector3.left);
			}
		...
		public override Selectable FindSelectableOnRight()
		{
			...
			if ((navigation.mode & Mode.Horizontal) != 0)
			{
				return FindSelectableCustom(transform.rotation * Vector3.right);
			}
		...
		public override Selectable FindSelectableOnUp()
		{
			...
			{
				return FindSelectableCustom(transform.rotation * Vector3.up);
			}
		...
		public override Selectable FindSelectableOnDown()
		{
			...
			if ((navigation.mode & Mode.Vertical) != 0)
			{
				return FindSelectableCustom(transform.rotation * Vector3.down);
			}
